...
const Inside = () => {
  ...
  const fetchData = async () => {
    const res = await fetch(`/api/getRepliedPost?name=${localStorage.getItem("name")}`, {
      method: "GET",
      headers: {
  ...
  return (
    <Box>
      <Stack direction="row" sx={{ ml: "25%", mt: "5%" }}>
        ...
        >
          <Typography sx={{ color: "white ", mb: "2%" }}>Replied Post </Typography>
